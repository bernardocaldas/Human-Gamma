function [ analysis ] = maxliksearch_rlalg(subject,game,varargin)
...
%end
    ...
    % should be:
    [ trace, env, stem, datadir ] = analyse.load_xdata(xid,subject,game,kwargs);
    % instead use:
%     [ trace, env, stem, indir ] = eval('analyse.load_xdata(xid,subject,game,kwargs)');
    ...
    case {'sarsa','qlearn'}
        ...
        case 'egreedy'
            ...
            %x0 = [0.1,0.7,0.1];
            x0range = [ [0.05,0.8];[0.2,0.9];[0.05,0.5];];
        case 'softmax'
